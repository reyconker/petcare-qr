...
import { Pill, Calendar, Clock, AlertTriangle, CheckCircle, Trash2 } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {treatments.map((treatment) => {
          const dosesLeft = treatment.doseAmount > 0 ? Math.floor(treatment.remainingQuantity / treatment.doseAmount) : 0;
          ...
          const isFinished = treatment.state === 'finalizado' || treatment.remainingQuantity < treatment.doseAmount;

          return (
            <div key={treatment.id} className="bg-white border rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden flex flex-col">
              ...
              <div className="flex justify-between items-start mb-1 mt-2">
                <h2 className="text-xl font-bold text-gray-800 mr-4">{treatment.name}</h2>
              ...
              <div className="mb-4 flex-1">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-gray-600">Stock del medicamento</span>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mb-3">
                  <div 
                    className={`h-2 rounded-full ${isLow ? 'bg-orange-500' : 'bg-teal-500'}`} 
              ...
              {isLow && !isFinished && (
                <div className="mb-4 flex items-center gap-2 text-orange-600 bg-orange-50 p-3 rounded-lg text-sm font-medium border border-orange-100">
                  ...
                  Queda stock para {daysLeft} días o menos.
                </div>
              )}
        ...
        {treatments.length === 0 && (
          <div className="col-span-1 md:col-span-2 flex flex-col items-center justify-center bg-white border border-dashed border-gray-300 rounded-xl p-12 text-center">
            ...
            <p className="text-gray-500 mb-6 max-w-md">Registra los medicamentos que toma tu mascota para recibir recordatorios diarios y controlar el stock.</p>
